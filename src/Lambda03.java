...
public class Lambda03 {
    public static void main(String[] args) {
        ...
        List<String> menu = new ArrayList<>(Arrays.asList("trileçe", "havucDilim", "guvec", "kokorec", "küşleme", "arabaşı", "waffle", "künefe", "guvec"));
        alfBykTekrsz(menu);
        System.out.println("**");
    ...
    public static void alfBykTekrsz(List<String> yemek) {
        ...
        yemek
                .stream() //akış başladı
                .map(String::toUpperCase) //Buyuk harf task
                .sorted()//doğal sıralama(Alfabetik )
                .distinct()//Tekrarsiz olmasini sağladı
...
// *********************** anyMatch() *** allMatch() **** noneMatch() ************************
    ...
    public static void harfSayisi7denAzKontrol(List<String> ikram) {
        System.out.println(ikram.
                stream().
                allMatch(t -> t.length() <= 7) ? "list elemanlari 7 ve 7 daha az harfden olusuyor" :
                "list elemanlari 7 harfden buyuk ");
    }

    // Task-5 : List elemanlarinin hepsinin  "w" ile baslamasini noneMatch() ile kontrol ediniz.
    ...
    public static void xIleBitenElKontrol(List<String> ikram) {
        System.out.println(ikram.
                stream().
                anyMatch(t -> t.endsWith("x")) ? "maşallah" : " x le yemek ismi biter mi hic ");
    }
